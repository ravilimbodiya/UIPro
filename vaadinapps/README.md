...
- vaadinapps-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- vaadinapps-ui: main application module, development time
- vaadinapps-production: module that produces a production mode WAR for deployment
