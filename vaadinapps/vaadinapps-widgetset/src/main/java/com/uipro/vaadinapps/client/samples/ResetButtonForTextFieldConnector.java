package com.uipro.vaadinapps.client.samples;
...
import com.uipro.vaadinapps.samples.ResetButtonForTextField;
...
public class ResetButtonForTextFieldConnector extends
    ...
    /*-{
        ...
        el.onclick = $entry(function () {
            self.@com.uipro.vaadinapps.client.samples.ResetButtonForTextFieldConnector::clearTextField()();
        });
    }-*/;
